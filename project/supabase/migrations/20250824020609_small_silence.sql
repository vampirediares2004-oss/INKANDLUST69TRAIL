/*
  # Complete INKANDLUST69 Database Schema
  ...
  1. New Tables
    ...
    - `chat_participants` - Users in each chat with admin privileges
  ...
  2. Security
    ...
    - Secure friend and chat access controls
...
-- Friendships table for mutual connections
...
-- Users policies
CREATE POLICY "Users can read all users for search" ON users FOR SELECT USING (true);
